...
async function getCarNames() {
  await post(
    'https://powerful-plains-19345.herokuapp.com/http://tsavhatnuatavel.appspot.com/getvalue?tag=רכבי צב התנועה'
  ).then(function(v) {
...
async function getCarData() {
  ...
  await post(
    `https://powerful-plains-19345.herokuapp.com/http://tsavhatnuatavel.appspot.com/getvalue?tag=תאריך_קודם`
  ).then(function(v) {
  ...
  for (let i = 0; i < carNames.length; i++) {
    ...
    await post(
      `https://powerful-plains-19345.herokuapp.com/http://tsavhatnuatavel.appspot.com/getvalue?tag=${
        carNames[i]
      }_קמ_קודם`
    ).then(function(v) {
